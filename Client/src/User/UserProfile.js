...
function UserProfile() {
    ...
    return (
        <div className="container mt-4" style={{ backgroundColor: '#f9f9f9', padding: '20px', borderRadius: '8px' }}>
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" pattern="^[a-zA-Z0-9_ ]*$" title="letters and numbers only, no punctuation or special characters" required onChange={(e) => setName(e.target.value)} value={name} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>Address</b></label>
                            <input type="text" className="form-control" pattern="^[#.0-9a-zA-Z\s,-/]+$" title="Enter the number and characters" required onChange={(e) => setAdd(e.target.value)} value={add} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>Pincode</b></label>
                            <input type="number" className="form-control" pattern="^[1-9]{1}[0-9]{2}\s{0,1}[0-9]{3}$" title="Enter only number values" required onChange={(e) => setPincode(e.target.value)} value={pincode} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>City</b></label>
                            <input type="text" className="form-control" pattern="[a-zA-Z]+" title="Enter only characters" required onChange={(e) => setCity(e.target.value)} value={city} />
                        </div>
                        <div className="form-group mt-3">
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" pattern="[6-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaining 9 digits with 0-9" required onChange={(e) => setMobile(e.target.value)} value={mobile} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>Email</b></label>
                            <input type="email" className="form-control" pattern="[a-z0-9]+@[a-z]+\.[a-z]{2,3}" title="Enter a valid email id" required onChange={(e) => setEmail(e.target.value)} value={email} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>Password</b></label>
                            <input type="password" className="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required onChange={(e) => setPass(e.target.value)} value={pass} />
                        </div>
                        <div className="form-group mt-3">
                            <label><b>Confirm Password</b></label>
                            <input type="password" className="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required onChange={(e) => setCpass(e.target.value)} value={cpass} />
                        </div>
                        <div className="form-group mt-3">
